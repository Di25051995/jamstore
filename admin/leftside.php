...
<section class="admin-content row space-between">
        ...
        <div class="header-top-left">
            <a href="index.php"><p> <span>Jam</span>store</p></a>
        </div>
            <ul>
                <li><a  href="#"> <img style="width:20px" src="icon/hi.png" alt="">Chào:  <span style="color:blue; font-size:22px"><?php echo Session::get('admin_name') ?></span><span style="color: red; font-size:20px">&#10084;</span></a>
